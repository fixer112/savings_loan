            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md">
                            ...
                            <p><button class="btn btn-info"><i class="fa fa-eye"></i><a href="/staff/customer/collateral/{{$user->id}}">view Collaterals</a></button> <button class="btn btn-info"><i class="fa fa-eye"></i><a href="/{{$user->idcard}}">view IdCard</a></button></p>
