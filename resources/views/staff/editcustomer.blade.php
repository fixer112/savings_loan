...
<form class="form-horizontal" method="POST" action="/staff/customer/edit/{{$user->id}}" files="true" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{method_field('PUT')}}
                        ...
                        <div class="form-group{{ $errors->has('gara1_name') ? ' has-error' : '' }}">
                            <label for="gara1_name" class="col-md-4 control-label">First Garantor Name</label>
                        ...
                        <div class="form-group{{ $errors->has('gara1_add') ? ' has-error' : '' }}">
                            <label for="gara1_add" class="col-md-4 control-label">First Garantor Address</label>
                        ...
                        <div class="form-group{{ $errors->has('gara1_occupation') ? ' has-error' : '' }}">
                            <label for="gara1_occupation" class="col-md-4 control-label">First Garantor Occupation</label>
                        ...
                        <div class="form-group{{ $errors->has('gara1_number') ? ' has-error' : '' }}">
                            <label for="gara1_number" class="col-md-4 control-label">First Garantor Mobile Number</label>
                        ...
                        <div class="form-group{{ $errors->has('gara1_verify') ? ' has-error' : '' }}">
                            <label for="gara1_verify" class="col-md-4 control-label">First Garantor Verfy</label>
                        ...
                        <div class="form-group{{ $errors->has('gara1_passport') ? ' has-error' : '' }}">
                            <label for="gara1_passport" class="col-md-4 control-label">First Garantor Passport</label>
                        ...
                        <div class="form-group{{ $errors->has('gara2_name') ? ' has-error' : '' }}">
                            <label for="gara2_name" class="col-md-4 control-label">Second Garantor Name</label>
                        ...
                        <div class="form-group{{ $errors->has('gara2_add') ? ' has-error' : '' }}">
                            <label for="gara2_add" class="col-md-4 control-label">Second Garantor Address</label>
                        ...
                        <div class="form-group{{ $errors->has('gara2_occupation') ? ' has-error' : '' }}">
                            <label for="gara2_occupation" class="col-md-4 control-label">Second Garantor Occupation</label>
                        ...
                        <div class="form-group{{ $errors->has('gara2_number') ? ' has-error' : '' }}">
                            <label for="gara2_number" class="col-md-4 control-label">Second Garantor Mobile Number</label>
                        ...
                        <div class="form-group{{ $errors->has('gara2_verify') ? ' has-error' : '' }}">
                            <label for="gara2_verify" class="col-md-4 control-label">Second Garantor Verfy</label>
                        ...
                        <div class="form-group{{ $errors->has('gara2_passport') ? ' has-error' : '' }}">
                            <label for="gara2_passport" class="col-md-4 control-label">Garantor Passport</label>
