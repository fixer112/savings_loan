    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header"><strong>ADD ADMIN Mini</strong></div>
...
<form class="form-horizontal" method="POST" action="/admin/createadmin2" files="true" enctype="multipart/form-data">
                        {{ csrf_field() }}
