            ...
            <table class="search table table-bordered" id="" width="100%" cellspacing="0">
              ...
              @foreach ($searchs as $search)
                <tr>
                  ...
                  <td><button class="btn btn-success"><i class="fa fa-eye"></i><a href="/admin/customer/{{$search->id}}">View</a></button>
                  <button class="btn btn-danger"><i class="fa fa-edit"></i><a href="/admin/customer/edit/{{$search->id}}">Edit</a></button>
