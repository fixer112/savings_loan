    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @if (session('success'))
                    ...
                    <form class="form-horizontal" method="POST" action="/admin2/search">
                        {{ csrf_field() }}
            ...
            <table class="display table table-bordered" id="" width="100%" cellspacing="0">
              ...
              @foreach ($searchs as $search)
                <tr>
                  ...
                  <td><button class="btn btn-success"><i class="fa fa-eye"></i><a href="/admin2/customer/{{$search->id}}">View</a></button>
                  {{-- <button class="btn btn-danger"><i class="fa fa-edit"></i><a href="/admin2/customer/edit/{{$search->id}}">Edit</a></button> --}}
                  </td>
