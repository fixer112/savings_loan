...
$start = $data['carbon']->now()->startOfWeek()->format('Y-m-d');
$end = $data['carbon']->now()->endOfWeek()->format('Y-m-d');
...
@section('title')
HONEYPAYS | This Week Statistics
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header"><strong>This Week Statistics</strong></div>
